...
import { Button, Card, Image, Link, Tooltip } from "@nextui-org/react";
...
const streamList = [
    ...
    },
    {
        ...
        creator: "Moviersals",
        views: 245,
        description: "Nội dung phim Light Shop Full tập xoay quanh một cửa hàng ánh sáng huyền bí, nơi những người đến tìm kiếm ánh sáng kỳ diệu sẽ đối mặt với những quyết định khó khăn giữa tình yêu, số phận và những lực lượng siêu nhiên.",
    ...
    },
    {
        ...
        creator: "Moviersals",
        views: 2032,
        description: "Death’s game là một trong những bộ phim Hàn Quốc thu hút nhiều người xem vào cuối năm 2023 nay. Có rất nhiều điều về bộ phim khiến cho người xem ấn tượng dù chỉ mới chiếu vài tập đầu tiên như diễn xuất, nội dung và đặc biệt là dàn diễn viên tham gia.",
...
export default function StreamList(): JSX.Element {
    return (
        <>
            {streamList.map((item) => (
                <Tooltip content="Chức năng sẽ ra mắt trong thời gian tới. Cảm ơn quý khách đã quan tâm!" showArrow={true} key={item.id} size="lg">
